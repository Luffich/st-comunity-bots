...
async def info(ctx,member:discord.Member):
    ...
    if member.status == discord.Status.online:
        emb.add_field(name='Статус дискорд:', value=':green_circle: Онлайн', inline=False)
    elif member.status == discord.Status.dnd:
        emb.add_field(name='Статус дискорд:', value=':no_entry: Не беспокоить', inline=False)
    elif member.status == discord.Status.offline:
        emb.add_field(name='Статус дискорд:', value=':black_circle: Нет в сети', inline=False)
    elif member.status == discord.Status.idle:
        emb.add_field(name='Статус дискорд:', value=':crescent_moon: Отошол', inline=False)
